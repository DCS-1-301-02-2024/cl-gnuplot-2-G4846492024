...
plot "weather2024.csv" using 1:2 with lines t "最高気温", "weather2024.csv" using 1:3 w l t "最高気温(平均)", "weather2024.csv" using 1:4 w l t "最低気温", "weather2024.csv" using 1:5 w l t "最低気温(平均)"
```
